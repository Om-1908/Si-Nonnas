...
export default function Dashboard() {
  ...
  const quickActions = [
    ...
    { icon: 'restaurant_menu', label: 'Menu', to: '/manager/menu' },
  ];
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="font-heading text-3xl font-bold text-[#ffdbc7]">Welcome back, Pranjal Bhamare</h1>
      ...
      {/* Full-width content — right panel removed */}
        ...
        <div className="bg-[#2e1b0e] rounded-[4px] p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            {activeOrders.length === 0 && (
              <p className="text-[#544434] text-sm col-span-3 text-center py-4">No active orders right now</p>
            )}
          </div>
        </div>
